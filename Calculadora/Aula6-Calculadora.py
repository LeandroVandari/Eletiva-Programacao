...
def dar_resultado():
    calculo = eval(texto.get(1.0, "end"))
    texto.delete(1.0, "end")
    texto.insert(1.0,calculo)
...
botao_igual=tk.Button(janela, text="=",command=lambda:dar_resultado(),width=27, height=4,font=("Arial",12))
botao_igual.grid(column=1,row=6,columnspan=2)
botao_C=tk.Button(janela, text="C",command=lambda:limpar_tela(),width=27, height=4,font=("Arial",12))
